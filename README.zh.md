...
DeepBlend tests: 11/71 file(s) passed
```
...
预期：**17 个套件、87 个文件**全部通过。其中契约层（`run.mjs`，不需要 Blender）是
**71 个文件 = 1581 项自计断言（34 个文件打印计数）+ 398 个 `node:test` 用例（37 个文件）**。
