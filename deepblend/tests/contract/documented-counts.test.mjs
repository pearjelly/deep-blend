 ...
 * -----------------------------------
 * The assertion TOTALS (the 830-checks / 170-cases pair in the README). Those cannot be
 ...
 * measured values are 830 and 170. No single commit made that wrong — each one added
