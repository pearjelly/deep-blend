 ...
 * -----------------------------------
 * The assertion TOTALS (the 830-checks / 167-cases pair in the README). Those cannot be
 ...
 * measured values are 830 and 167. No single commit made that wrong — each one added
